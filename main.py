...
from gen_response_and_citations import cohere_chat
...
class MultilingualClimateChatbot:
    ...
    def _initialize_nova_flow(self) -> None:
        ...
        self.nova_model = BedrockModel("amazon.nova-micro-v1:0")
    ...
    async def process_query(
            ...
            try:
                ...
                try:
                    ...
                    response, citations = cohere_chat(processed_query, reranked_docs, self.cohere_client)
                ...
                try:
                    ...
                    if faithfulness_score < 0.6: 
                        ...
                        regenerated_response, regenerated_citations = cohere_chat(processed_query, reranked_docs, self.cohere_client, description)
    ...
    async def _try_tavily_fallback(self, query: str, english_query: str, language_name: str) -> Tuple[Optional[str], Optional[List], float]:
        ...
        try:
            ...
            fallback_response, fallback_citations = cohere_chat(query, documents_for_cohere, self.cohere_client, description)
